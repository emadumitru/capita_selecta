...
def convert_to_hex(rgb):
    red = convert_to_hex_component(rgb[0])
    green = convert_to_hex_component(rgb[1])
    blue = convert_to_hex_component(rgb[2])
    return red + green + blue

def convert_to_hex_component(component):
    return hex(component)[2:].zfill(2)
