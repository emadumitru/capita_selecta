...
class TestWordFrequency(unittest.TestCase):
    ...
    def test_pre_word_frequency(self, mock_print):
        ...
        word_counts = pre_09_02.word_frequency_counter(text)
        pre_09_02.print_word_frequency(word_counts)
        expected_calls = [
    ...
    def test_ref_word_frequency(self, mock_print):
        text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, dignissim sit amet, adipiscing nec, ultricies sed, dolor."
        word_counts = ref_09_02.word_frequency_counter(text)
        ref_09_02.print_word_frequency(word_counts)
        expected_calls = [
            unittest.mock.call('amet: 2'),
            unittest.mock.call('dolor: 2'),
            unittest.mock.call('sit: 2'),
