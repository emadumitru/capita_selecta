...
class TestCheckerGame(unittest.TestCase):
    ...
    def test_pre_checker_game(self, mock_print, mock_input):
        pre_07_05.play_game()
        expected_calls = [
            ...
            unittest.mock.call('7 X   X   X   X '),
            unittest.mock.call('8   X   X   X   X'),
            unittest.mock.call('Congratulations! You reached the opposite side of the board.')
        ]
        mock_print.assert_has_calls(expected_calls, any_order=False)

    @patch('builtins.input', side_effect=['1', 'A', '2', 'B'])
    @patch('builtins.print')
    def test_ref_checker_game(self, mock_print, mock_input):
        ref_07_05.play_game()
        expected_calls = [
            unittest.mock.call('Welcome to the Peaceful Checker Game!'),
            unittest.mock.call('You can move your piece diagonally to an empty space.'),
